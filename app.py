...
from utils.model import model_deployment
...
# load model
model = model_deployment(num_classes=len(class_names))
model.load_state_dict(torch.load("models/EffnetB2_Baseline.pth", map_location=torch.device('cpu')))

# turn on evaluation mode
model.eval()

# membuat transformaasi gambar
